 ...
 * @author ASUS
 */
public class Signup_Teacher_kishorgongController implements Initializable {
    ...
    private void submit(ActionEvent event) throws SQLException {
        ...
        All_Teacher_Information_NilphamariDatabase teacher = new All_Teacher_Information_NilphamariDatabase();

        String queary = "insert into kishorgong values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject() + "','" + obj.getEducation() + "','" + obj.getSalary() + "')";
