 ...
 * @author ASUS
 */
public class JaldhakaTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from jaldhaka";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
        FindTeacher_Nilphamari_DistrictController.jaldhaka.close();
    }
