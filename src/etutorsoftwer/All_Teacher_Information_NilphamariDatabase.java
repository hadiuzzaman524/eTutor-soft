 ...
 * @author ASUS
 */
public class All_Teacher_Information_NilphamariDatabase {
            
   Connection getConnection() throws SQLException
    {  
        Connection conn=(Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/nilphamaridistrict", "root", "");
