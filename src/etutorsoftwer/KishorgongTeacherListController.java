 ...
 * @author ASUS
 */
public class KishorgongTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        All_Teacher_Information_NilphamariDatabase obj = new All_Teacher_Information_NilphamariDatabase();
        String queary = "select *from kishorgong";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
        FindTeacher_Nilphamari_DistrictController.kishorgong.close();
    }
