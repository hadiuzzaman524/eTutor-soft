 ...
 * @author ASUS
 */
public class Signup_Teacher_DomarController implements Initializable {
    ...
    private void submit(ActionEvent event) throws SQLException {
        ...
        String queary = "insert into domar values('" + obj.getName() + "','" + obj.getAddress() + "','" + obj.getEmail() + "','" + obj.getMobile() + "','" + obj.getInterestedsubject() + "','" + obj.getEducation() + "','" + obj.getSalary() + "')";
