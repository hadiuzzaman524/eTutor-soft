 ...
 * @author ASUS
 */
public class SaidpurTeacherListController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        String queary = "select *from saidpur";
        ResultSet rs;
        try {
    ...
    private void BackButton(ActionEvent event) {
         FindTeacher_Nilphamari_DistrictController.saidpur.close();
    }
